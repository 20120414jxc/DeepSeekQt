DeepSeekClient: \
  ...
  /usr/lib/aarch64-linux-gnu/libQt6WebEngineWidgets.so.6.9.2 \
  /usr/lib/aarch64-linux-gnu/libQt6WebEngineCore.so.6.9.2 \
  /usr/lib/aarch64-linux-gnu/libQt6WebChannel.so.6.9.2 \
  /usr/lib/aarch64-linux-gnu/libQt6Positioning.so.6.9.2 \
  /usr/lib/aarch64-linux-gnu/libQt6PrintSupport.so.6.9.2 \
  /usr/lib/aarch64-linux-gnu/libQt6Widgets.so.6.9.2 \
  /usr/lib/aarch64-linux-gnu/libQt6Quick.so.6.9.2 \
  /usr/lib/aarch64-linux-gnu/libQt6QmlMeta.so.6.9.2 \
  /usr/lib/aarch64-linux-gnu/libQt6QmlWorkerScript.so.6.9.2 \
  /usr/lib/aarch64-linux-gnu/libQt6QmlModels.so.6.9.2 \
  /usr/lib/aarch64-linux-gnu/libQt6OpenGL.so.6.9.2 \
  /usr/lib/aarch64-linux-gnu/libQt6Gui.so.6.9.2 \
  /usr/lib/aarch64-linux-gnu/libGLX.so \
  /usr/lib/aarch64-linux-gnu/libOpenGL.so \
  /usr/lib/aarch64-linux-gnu/libQt6Qml.so.6.9.2 \
  /usr/lib/aarch64-linux-gnu/libQt6Network.so.6.9.2 \
  ...
  /usr/lib/aarch64-linux-gnu/libQt6QuickWidgets.so.6 \
  /usr/lib/aarch64-linux-gnu/libQt6PrintSupport.so.6.9.2 \
  /usr/lib/aarch64-linux-gnu/libQt6Quick.so.6.9.2 \
  /lib/ld-linux-aarch64.so.1 \
  /usr/lib/aarch64-linux-gnu/libQt6WebChannel.so.6.9.2 \
  ...
  /usr/lib/aarch64-linux-gnu/libevent-2.1.so.7 \
  /usr/lib/aarch64-linux-gnu/libX11.so.6 \
  /usr/lib/aarch64-linux-gnu/libXcomposite.so.1 \
  /usr/lib/aarch64-linux-gnu/libXdamage.so.1 \
  ...
  /usr/lib/aarch64-linux-gnu/libharfbuzz-subset.so.0 \
  ...
  /usr/lib/aarch64-linux-gnu/libxslt.so.1 \
  ...
  /usr/lib/aarch64-linux-gnu/libxkbfile.so.1 \
  /usr/lib/aarch64-linux-gnu/libGLX.so \
  /usr/lib/aarch64-linux-gnu/libQt6Qml.so.6.9.2 \
  /usr/lib/aarch64-linux-gnu/libQt6Network.so.6.9.2 \
  /usr/lib/aarch64-linux-gnu/libm.so.6 \
  ...
  /usr/lib/aarch64-linux-gnu/libnghttp3.so.9 \
